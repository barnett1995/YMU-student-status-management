...
<label for="site">宿舍号</label>
<input type="text" id="sushe" name="site" placeholder="如：惠苑2Axxx号" required runat="server">
<label for="site">班级职务</label>
<input type="text" id="zhiwu" name="site" placeholder="班级职务" required runat="server">
...
<button type="submit" id="tijiao" runat="server" onserverclick="ButtonClick"  >提交信息</button>
<button type="submit" id="shenqing" runat="server" onserverclick="Button2Click"  >申请修改信息</button>
</form>
