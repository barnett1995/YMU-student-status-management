...
public partial class application0 : System.Web.UI.Page
{
    ...
    protected void add_ServerClick(object sender, EventArgs e)
    {
        ...
        string sestr = "SELECT * FROM Xi WHERE Xi_id='" + id + "' AND XM='" + nm + "' AND College_ID=(SELECT College_ID FROM College WHERE CM='" + xy + "')";
