<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Teacher8.aspx.cs" Inherits="Teacher8" %>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="Teacher.aspx" runat="server" id='A1' ><span class="hidden-tablet"  id="T1" runat="server">学生管理</span></a></li>
                        <li><a href="Teacher1.aspx" runat="server" id='A2'><span class="hidden-tablet" id="T2" runat="server"></span></a></li>
						<li><a href="Teacher2.aspx" runat="server" id='A3'><span class="hidden-tablet" id="T3" runat="server"></span></a></li>
						<li><a href="Teacher3.aspx" runat="server" id='A4'><span class="hidden-tablet" id="T4" runat="server"></span></a></li>
						<li><a href="Teacher4.aspx" runat="server" id='A5'><span class="hidden-tablet" id="T5" runat="server"></span></a></li>
                        <li><a href="Teacher5.aspx" runat="server" id='A6'><span class="hidden-tablet" id="T6" runat="server"></span></a></li>
						<li><a href="Teacher6.aspx" runat="server" id='A7'><span class="hidden-tablet"  id="T7" runat="server"></span></a></li>
						<li><a href="Teacher7.aspx" runat="server" id='A8'><span class="hidden-tablet" id="T8" runat="server"></span></a></li>
						<li><a href="Teacher8.aspx" runat="server" id='A9'><span class="hidden-tablet" id="T9" runat="server"></span></a></li>
						<li><a href="Teacher9.aspx" runat="server" id='A10'><span class="hidden-tablet" id="T10" runat="server"></span></a></li>
