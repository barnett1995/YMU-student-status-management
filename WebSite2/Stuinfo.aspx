				...
				<div id="div006" style="float:left;">
                    ...
                    <div id="div007" style="float:left;">                     
					    <table id="table001" border="1" cellspacing="0"  runat="server">
                            ...
                            <tr>
					           <td class="table1-1">宿舍号:</td>
                               <td class="table1-2" >
                                    <input id="suhe" runat="server" type="text" class="input1" onFocus="this.blur()" />
                               </td>					 
						    </tr>
                            <tr>
					           <td class="table1-1">班级职务:</td>
                               <td class="table1-2" >
                                    <input id="zhiwu" runat="server" type="text" class="input1" onFocus="this.blur()" />
                               </td>					 
						    </tr>
                            <tr>
