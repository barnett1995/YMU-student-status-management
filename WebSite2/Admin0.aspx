<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin0.aspx.cs" Inherits="Admin0" MaintainScrollPositionOnPostback="true" %>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span><h2>云南民族大学学籍管理系统(系主任/辅导员端) 班级管理</h2></span></a>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid"  style="text-align: center"> 
                 ...
                 <h2 style="font-weight: 300;">班级信息Excel上传：<h2>
                 <p>
                 ...
                 <input id="up" style="width: 180px;height: 30px" value="上传" type="submit" runat="server" onserverclick="shangchuan_Click">
                  ...
                  <h2 style="font-weight: 600;">单条添加班级信息：</h2>
                ...
                <h2 style="font-weight: 600;">查询班级信息：</h2>      
