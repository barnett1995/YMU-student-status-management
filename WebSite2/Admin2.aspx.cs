...
public partial class Admin2 : System.Web.UI.Page
{
    ...
    private void DataSetOperator(DataSet ds, string filePath)
    {
        ...
        finally                                                             //finally 块释放资源，例如，关闭在 try 块中打开的任何流或文件。
        {
            ...
            this.ClientScript.RegisterStartupScript(this.GetType(), "", "alert('上传成功" + num + " 条')", true);
    ...
    protected void add_ServerClick(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                string instr = "INSERT INTO si(ID,Name,password,College_ID,Xi_id,classid,nianji,Authority,apply,overrule) VALUES('" + id + "','" + nm + "','" + pwd + "','" + xyid + "','" + xid + "','" + cid + "','" + nj + "','true','false','false';); insert into Experience(ID) VALUES ('" + id + "'),('" + id + "'),('" + id + "'),('" + id + "'),('" + id + "'),('" + id + "');  insert into marriage(ID) VALUES ('" + id + "'),('" + id + "'),('" + id + "'),('" + id + "'),('" + id + "'),('" + id + "'); insert into Relation(ID) VALUES ('" + id + "'),('" + id + "'),('" + id + "'),('" + id + "'),('" + id + "'),('" + id + "'),'true','false','false';";
    ...
    protected void chaxun_ServerClick(object sender, EventArgs e)
    {
        ...
        Application["bj"] = cl;
        Application["grade"] = nj;
        Application["xuehao"] = id;
        //  Response.Write("<script language='javascript'>window.open('View2.aspx','','height=800,width=700,scrollbars=yes,status =yes')</script>");
        this.ClientScript.RegisterStartupScript(this.GetType(), "", "window.open('View2.aspx','','height=800,width=1000,scrollbars=yes,status =yes')", true);
